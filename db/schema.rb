...
ActiveRecord::Schema.define(version: 2022_01_17_014333) do

  create_table "modes", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "filter"
